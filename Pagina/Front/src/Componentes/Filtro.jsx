...
const Filtro = ({Buscar_Tipo_vuelo, Buscar_Destino, setTipo_vuelo, Buscar_Origen, origen, setOrigen, destino, setDestino}) => {
    ...
    return(
        <div className="contenedor_filtro">
            ...
            <form action="">
                <input type="text" name="" id="" placeholder="Origen" value={origen} onChange={(e) => setOrigen(e.target.value)} onInput={Buscar_Origen}/>
                <button type="button">Filtrar</button>
            </form>


             <form action="" onSubmit={Buscar_Destino}>
                <input type="text" name="" id="" placeholder="Destino" value={destino} onChange={(e) => setDestino(e.target.value)} onInput={Buscar_Destino}/>
                <button type="button">Filtrar</button>
            </form>
